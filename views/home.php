    ...
    <div class="bg-white rounded-xl overflow-hidden shadow-lg">
        <div class="relative">
            ...
            <div class="absolute top-4 left-4 z-10">
                <span class="bg-gold text-white px-3 sm:px-4 py-1 sm:py-1.5 rounded-full text-sm font-medium">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 text-white">
                <h3 class="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4 leading-tight">
                    <?php echo e($featuredPost['title']); ?>
                </h3>
                
                <p class="text-gray-100 mb-4 sm:mb-6 line-clamp-2 text-base sm:text-lg">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden bg-white">
                        ...
                        <div>
                            <span class="block font-medium text-sm sm:text-base"><?php echo e($featuredPost['author_name']); ?></span>
                            <span class="text-xs sm:text-sm text-gray-300"><?php echo formatDate($featuredPost['created_at']); ?></span>
                        </div>
                    </div>
                    ...
                    <?php foreach ($recentPosts as $post): ?>
                        <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                            ...
                            <div class="p-3 sm:p-4">
                                ...
                                <p class="text-gray-600 mb-4 text-sm sm:text-base"><?php echo createExcerpt($post['content'], 100); ?></p>
